...
var $buo = function(op, test) {
    ...
    if (this.op.betatest || (!this.op.test && ll === "en" && this.op.reminder > 1 && Math.random() * 50 < 1)) {
        ...
        e.src = (/file:/.test(location.href)) ? "update.showx.js" : "/assets/js/update.showx.js";
    ...
    div.id = "buorg";
    div.className = "buorg";
    var style = "<style>.buorg {position:absolute;position:fixed;z-index:111111;width:384px; top:50%; left:50%; margin-left: -192px; margin-top: -50px; border-bottom:1px solid #A29330;background:#FDF2AB no-repeat 14px center url(/assets/img/small/" + bb.n + ".png);text-align:left; cursor:pointer;font: 16px Arial,sans-serif;color:#000;}.buorg div { padding:5px 5px 5px 40px; }.buorg>div>a,.buorg>div>a:visited{color:#E25600; text-decoration: underline;}#buorgclose{display:none; position:absolute;right:6px;top:0px;height:20px;width:12px;font:18px bold;padding:0;}#buorga{display:block;}#buorgcc{display:block;position:absolute; top:-99999px;}@media only screen and (max-width: 700px){.buorg {background-image: none;} .buorg div { padding:5px 15px 5px 9px; }}</style>";
